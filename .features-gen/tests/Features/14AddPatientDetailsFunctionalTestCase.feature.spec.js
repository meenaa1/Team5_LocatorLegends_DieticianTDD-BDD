...
test.describe('Add Patient Details - Functional Test Cases', () => {
  ...
  test.beforeEach('Background', async ({ Given }, testInfo) => { if (testInfo.error) return;
    await Given('User is in Add Patient Details dialog box'); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":119,"pickleLine":96,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":3,"keywordType":"Context","textWithKeyword":"Given User is in Add Patient Details dialog box","isBg":true,"stepMatchArguments":[]},{"pwStepLine":120,"gherkinStepLine":97,"keywordType":"Action","textWithKeyword":"When User clicks Submit after uploading a valid file","stepMatchArguments":[]},{"pwStepLine":121,"gherkinStepLine":98,"keywordType":"Outcome","textWithKeyword":"Then User should be redirected to My Patient page with the uploaded file saved successfully","stepMatchArguments":[]}]},
  {"pwTestLine":124,"pickleLine":100,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":3,"keywordType":"Context","textWithKeyword":"Given User is in Add Patient Details dialog box","isBg":true,"stepMatchArguments":[]},{"pwStepLine":125,"gherkinStepLine":101,"keywordType":"Action","textWithKeyword":"When User uploads health report in pdf","stepMatchArguments":[]},{"pwStepLine":126,"gherkinStepLine":102,"keywordType":"Outcome","textWithKeyword":"Then User should see uploaded file name with extension","stepMatchArguments":[]}]},
