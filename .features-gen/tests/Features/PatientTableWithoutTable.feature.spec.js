// Generated from: tests\Features\PatientTableWithoutTable.feature
...
test.describe('Patient table without record', () => {
  ...
  test('Verify that My Patient page loads with empty table', async ({ Given, When, Then }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\Features\\PatientTableWithoutTable.feature'), { scope: 'test', box: true }],
