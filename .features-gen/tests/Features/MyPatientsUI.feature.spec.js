// Generated from: tests\Features\MyPatientsUI.feature
import { test } from "playwright-bdd";

test.describe('My Patients Page UI', () => {

  test.beforeEach('Background', async ({ Given }, testInfo) => { if (testInfo.error) return;
    await Given('User is logged into the application'); 
  });
  ...
  test('Verify the Title is displayed', async ({ Given, When, Then }) => { 
    ...
    await Then('Page header "My Patients" should be displayed'); 
  });

  test('Verify the Search bar display', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Search bar should be displayed'); 
  });

  test('Verify the Search icon', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Search icon should be displayed inside the search bar'); 
  });

  test('Verify the Search placeholder text', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Placeholder text "Search..." should be displayed'); 
  });

  test('Verify the Table column header', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('"Patient Id", "Name", "Details" , "Last Visit Date", "Actions" , " Edit/Delete" should be displayed'); 
  });

  test('Verify the Patient Id column sorting icon', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Up and down arrow icons should be displayed in the Patient Id column header'); 
  });

  test('Verify the Name column sorting icon', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Up and down arrow icons should be displayed in the Name column header'); 
  });
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\Features\\MyPatientsUI.feature'), { scope: 'test', box: true }],
