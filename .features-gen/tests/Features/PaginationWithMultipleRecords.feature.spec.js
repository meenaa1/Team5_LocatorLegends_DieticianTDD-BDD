// Generated from: tests\Features\PaginationWithMultipleRecords.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\Features\\PaginationWithMultipleRecords.feature'), { scope: 'test', box: true }],
