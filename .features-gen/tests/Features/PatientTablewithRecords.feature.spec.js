// Generated from: tests\Features\PatientTablewithRecords.feature
import { test } from "../../../tests/Fixtures/testFixtures.js";

test.describe('Patient Table details with record', () => {

  test('Verify the Patient list display', async ({ Given, When, Then }) => { 
  ...
  test('Verify the Edit icon displayed for each row', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
    await Then('Edit icon should be displayed for each patient record'); 
  });

  test('Verify the Delete icon displayed for each row', async ({ Given, When, Then }) => { 
    await Given('User is in dietician application dashboard page'); 
    await When('User clicks on My Patients button'); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\Features\\PatientTablewithRecords.feature'), { scope: 'test', box: true }],
