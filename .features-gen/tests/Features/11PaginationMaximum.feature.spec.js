// Generated from: tests\Features\11PaginationMaximum.feature
...
test.describe('Pagination management with maximum record in a page', () => {
  ...
  test('Verify that Each page should display only 5 records', async ({ Given, When, Then, dashboardPage, myPatientsPage }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\Features\\11PaginationMaximum.feature'), { scope: 'test', box: true }],
